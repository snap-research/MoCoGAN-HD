...
def GD_step(opt, modelG, modelD_img, modelD_3d, data, x, z):
    ...
    for i in range(opt.G_step):
        G_loss, G_loss_3d, l_mutual = G_step(opt, modelG, modelD_img,
                                             modelD_3d, x, z)
    ...
    loss_names = [
        'D_real', 'D_fake', 'D_real_3d', 'D_fake_3d', 'G', 'G_3d', 'l_mutual'
    ]

    loss_all = [
        D_loss_real, D_loss_fake, D_loss_real_3d, D_loss_fake_3d, G_loss,
        G_loss_3d, l_mutual
    ]
